...
public class IssueQueryFactoryTest {
  ...
  public void application_search_project_issues() {
    ...
    assertThat(result.projectUuids()).containsExactlyInAnyOrder(project1.uuid(), project2.uuid());
  }
  ...
  public void application_search_project_issues_on_leak() {
    ...
    assertThat(result.projectUuids()).containsExactlyInAnyOrder(project1.uuid(), project2.uuid(), project3.uuid());
  }
